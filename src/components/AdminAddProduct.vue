  ...
  <q-card flat bordered>
    ...
    <q-card-section>
      <q-form @submit.prevent="addProduct">
        ...
        <q-input v-model="produs.descriere" label="Descriere" type="textarea" filled class="q-mt-md" />
        <q-input v-model="produs.categorie" label="Categorie" filled class="q-mt-md" />
        <q-input v-model.number="produs.pret" label="Preț" type="number" step="0.01" filled class="q-mt-md" required />
        <q-input v-model.number="produs.stoc" label="Stoc" type="number" filled class="q-mt-md" required />
        <q-input v-model="produs.imagine" label="URL Imagine" filled class="q-mt-md" />

        <q-btn label="Adaugă Produs" type="submit" color="primary" class="q-mt-lg" :loading="loading" />
      </q-form>
    </q-card-section>
  </q-card>
</template>
